/**
 * Auto-Recovery Browser Performance Collector
 * 
 * This version persists across page refreshes using sessionStorage.
 * 
 * Usage:
 * 1. Open DevTools (F12) -> Console tab
 * 2. Copy ALL code below and paste into console
 * 3. Press Enter
 * 4. Refresh page (F5) - function will auto-recover!
 * 5. After page loads, run: collectPerformanceMetrics()
 */
...
(function() {
    ...
    const STORAGE_KEY = '__perf_collector_active';
    const isRecovery = sessionStorage.getItem(STORAGE_KEY) === 'true';
    
    if (isRecovery) {
        console.log('[PERF] 🔄 Recovering performance collector after page refresh...');
    }
    ...
    // Mark as active in sessionStorage (survives refresh)
    ...
    if (isRecovery) {
        console.log('[PERF] ✅ Performance collector recovered!');
        console.log('[PERF] ✅ Function available: collectPerformanceMetrics()');
        console.log('[PERF] 📊 Run: collectPerformanceMetrics() to see metrics');
    } else {
        console.log('[PERF] ✅ Performance monitoring started!');
        console.log('[PERF] ✅ Function available: collectPerformanceMetrics()');
        console.log('[PERF] 🔄 This will persist across page refreshes');
        console.log('[PERF] 📝 Next: Refresh page (F5), then run: collectPerformanceMetrics()');
    }
